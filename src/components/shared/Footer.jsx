        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.tiktok.com/@ridersgearnairobi?_r=1&_t=ZS-984xUTSnt2N" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-morning flex items-center justify-center text-pebble hover:bg-jade hover:text-white transition-all transform hover:-translate-y-1">
